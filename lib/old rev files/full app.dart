                  ...
                  children: [
                    ...
                    IconButton(
                      icon: Icon(
                        ...
                        color:
                            _autoPlayEnabled ? const Color(0xFF417D7A) : Colors.grey,
                        size: 24,
                      ),
                      onPressed: () {
                        setState(() {
                                                            ...
                                                            color: _showFirstWordOnly
                                                                ? (isRevealed
                                                                    ? (_forgottenAyahs[widget.pageNumber]?.contains(ayahIndex + 1) ?? false
                                                                        ? const Color.fromARGB(255, 66, 10, 10) // Light red for specific review ayah
          ...
          ..._celebrationStyles
              ...
              .map((entry) => Align(
                    ...
                    child: ConfettiWidget(
                      ...
                      maxBlastForce:
                          entry.value['type'] == 'fireworks' ? 20.0 : 7.0,
                      minBlastForce:
                          entry.value['type'] == 'fireworks' ? 10.0 : 3.0,
                      emissionFrequency:
                          entry.value['type'] == 'birthday' ? 0.1 : 0.05,
                      numberOfParticles: entry.value['particles'],
